...
class CharacterForm(forms.ModelForm):
    class Meta:
        ...
        fields = [
            ...
            'spell_attack_bonus', 'spell_slots_total_level_1', 'spell_slots_used_level_1_1', 'spell_slots_used_level_1_2',
            'spell_slots_used_level_1_3', 'spell_slots_used_level_1_4', 'spell_slots_total_level_2',
            'spell_slots_used_level_2_1', 'spell_slots_used_level_2_2', 'spell_slots_used_level_2_3',
            'spell_slots_total_level_3', 'spell_slots_used_level_3_1', 'spell_slots_used_level_3_2',
            'spell_slots_used_level_3_3', 'spell_slots_total_level_4', 'spell_slots_used_level_4_1',
            'spell_slots_used_level_4_2', 'spell_slots_used_level_4_3', 'spell_slots_total_level_5',
            'spell_slots_used_level_5_1', 'spell_slots_used_level_5_2', 'spell_slots_used_level_5_3',
            'spell_slots_total_level_6', 'spell_slots_used_level_6_1', 'spell_slots_used_level_6_2',
            'spell_slots_total_level_7', 'spell_slots_used_level_7_1', 'spell_slots_used_level_7_2',
            'spell_slots_total_level_8', 'spell_slots_used_level_8_1', 'spell_slots_total_level_9',
            'spell_slots_used_level_9_1', 'appearance_area', 'backstory_personality', 'alignment', 'languages',
            'equipment', 'magic_attunement_1', 'magic_attunement_1_name', 'magic_attunement_2', 'magic_attunement_2_name',
            'magic_attunement_3', 'magic_attunement_3_name', 'cp', 'sp', 'ep', 'gp', 'pp',
        ]
